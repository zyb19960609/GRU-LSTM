...
parser.add_argument("--dataset_name", default="v", type=str)
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            for (start, end) in seq_start_end:
                ...
                img = plt.imread("/home/zyb/桌面/21.jpg")
                plt.close()
                fig, ax = plt.subplots(figsize=(20, 15), dpi=100)  # [0, 33, -2, 13])
                ax.imshow(img, extent=[-2, 40, -2, 44.4])
                ...
                plt.close()
                pic_cnt += 1
                #plt.plot(observed_line,ground_line,predict_line)
...
if __name__ == "__main__":
    ...
    os.mkdir("./traj_fig")
    #img = plt.imread("/home/zyb/桌面/GRU-LSTM20230415/314.png")
    main(args)
